...
const jobber_shared_1 = require("@CauaHenrique19/jobber-shared");
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            channel.consume(jobberQueue.queue, (msg) => __awaiter(this, void 0, void 0, function* () {
                const { receiverEmail, username, verifyLink, resetLink, template, sender, offerLink, amount, buyerUsername, sellerUsername, title, description, deliveryDays, orderId, orderDue, requirements, orderUrl, originalDate, newDate, reason, subject, header, type, message, serviceFee, total, } = JSON.parse(msg.content.toString());
                const locals = {
                    appLink: config_1.config.CLIENT_URL,
                    appIcon: "https://i.ibb.co/Kyp2m0t/cover.png",
                    username,
